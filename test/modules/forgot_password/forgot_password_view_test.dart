...
void main() {
  describe("a ForgotPassword view", () {
    ...
    describe("it's clearEmailTextField() is called", () {
      beforeEach((tester) async {
    ...
    describe("it's setResetButton() is called", () {
    ...
    describe("it's showResetSuccessfullyNotification() is called", () {
      beforeEach((tester) async {
    ...
    describe("it's reset button is tapped", () {
      beforeEach((tester) async {
        module.view.setResetButton(isEnabled: true);
        await tester.pumpAndSettle();
