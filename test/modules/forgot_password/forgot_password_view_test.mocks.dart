...
// in survey/test/modules/forgot_password/forgot_password_view_test.dart.
...
/// A class which mocks [ForgotPasswordViewDelegate].
///
/// See the documentation for Mockito's code generation for more information.
class MockForgotPasswordViewDelegate extends _i1.Mock
    implements _i3.ForgotPasswordViewDelegate {
  MockForgotPasswordViewDelegate() {
  ...
  @override
  _i2.BehaviorSubject<String> get resetButtonDidTap =>
      (super.noSuchMethod(Invocation.getter(#resetButtonDidTap),
              returnValue: _FakeBehaviorSubject<String>())
          as _i2.BehaviorSubject<String>);
  @override
