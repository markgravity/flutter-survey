...
void main() {
  describe("a Landing presenter", () {
    ...
    describe("it's emailTextFieldDidChange emits", () {
    ...
    describe("it's resetButtonDidTap emits", () {
      beforeEach(() {
    ...
    describe("it's passwordDidReset emits", () {
      beforeEach(() {
    ...
    describe("it's passwordDidFailToReset emits", () {
