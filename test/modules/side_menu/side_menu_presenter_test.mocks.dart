...
import 'package:survey/models/user_info.dart' as _i4;
...
class MockSideMenuView extends _i1.Mock implements _i3.SideMenuView {
  MockSideMenuView() {
    _i1.throwOnMissingStub(this);
  }

  @override
  set delegate(_i3.SideMenuViewDelegate? _delegate) =>
  ...
  @override
  void setUser(_i4.UserInfo? user) =>
...
///
/// See the documentation for Mockito's code generation for more information.
class MockSideMenuRouter extends _i1.Mock implements _i3.SideMenuRouter {
  MockSideMenuRouter() {
    _i1.throwOnMissingStub(this);
  }
...
class MockSideMenuInteractor extends _i1.Mock
    implements _i3.SideMenuInteractor {
  MockSideMenuInteractor() {
    _i1.throwOnMissingStub(this);
  }

  @override
  set delegate(_i3.SideMenuInteractorDelegate? _delegate) =>
      super.noSuchMethod(Invocation.setter(#delegate, _delegate),
          returnValueForMissingStub: null);
  @override
